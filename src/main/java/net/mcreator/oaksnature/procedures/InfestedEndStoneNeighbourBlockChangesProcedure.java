...
public class InfestedEndStoneNeighbourBlockChangesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (OaksNatureModBlocks.INFESTED_END_STONE.get() == (world.getBlockState(BlockPos.containing(x, y, z))).getBlock()) {
