...
public class VaseGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public VaseGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OaksNatureModMenus.VASE_GUI.get(), id);
