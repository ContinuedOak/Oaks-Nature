...
import net.mcreator.oaksnature.procedures.LimestoneRedstoneOreEntityWalksOnTheBlockProcedure;

public class LimestoneRedstoneOreBlock extends Block {
	public LimestoneRedstoneOreBlock() {
	...
	public void stepOn(Level world, BlockPos pos, BlockState blockstate, Entity entity) {
		...
		LimestoneRedstoneOreEntityWalksOnTheBlockProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
