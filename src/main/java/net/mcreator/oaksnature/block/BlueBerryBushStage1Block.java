...
import net.mcreator.oaksnature.procedures.BlueBerryBushStage1UpdateTickProcedure;
...
public class BlueBerryBushStage1Block extends FlowerBlock {
	public BlueBerryBushStage1Block() {
		super(() -> MobEffects.MOVEMENT_SPEED, 100, BlockBehaviour.Properties.of(Material.PLANT).randomTicks().sound(SoundType.GRASS).strength(0.4f, 0f).noCollission().offsetType(BlockBehaviour.OffsetType.NONE));
	}
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		BlueBerryBushStage1UpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
