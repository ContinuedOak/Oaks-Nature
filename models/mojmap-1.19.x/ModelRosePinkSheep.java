...
public class ModelRosePinkSheep<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rosepinksheep"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rotation = body
				.addOrReplaceChild("rotation",
						CubeListBuilder.create().texOffs(28, 0).addBox(-4.0F, -10.0F, -7.0F, 8.0F, 16.0F, 6.0F,
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(28, 22).addBox(
				-3.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, 6.0F, -8.0F));
		...
		PartDefinition leg1 = leg8.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 54).addBox(-2.0F, 0.0F,
		...
		PartDefinition leg2 = leg7.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(16, 54).addBox(-2.0F,
		...
		PartDefinition leg3 = leg6.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(48, 54).addBox(-2.0F,
				0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition leg4 = leg5.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(32, 54).addBox(-2.0F,
				0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
